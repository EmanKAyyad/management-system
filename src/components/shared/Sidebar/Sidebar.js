  ...
  return <div className="sidebar d-none d-md-block">
    ...
    <nav>
      <ul className="main-menu">
        ...
        <li><a className={submenuTwoFlag ? 'active' : null} data-toggle="collapse" href="#sub-menu02" role="button" aria-expanded="false" aria-controls="sub-menu02">
          ...
          <ul className="sub-menu collapse" id="sub-menu02">
            {subMenuTwo}
          </ul>
        </li>
